...
Out:
    ...
    - Events []
*/
exports.getEventFromLocation = functions.https.onRequest((request, response) => {
    response.send("{\"status\":\"success\"}");
});
/*
...
Out:
    ...
    - Events []
*/
exports.getEventsBuyedByUser = functions.https.onRequest((request, response) => {
    response.send("{\"status\":\"success\"}");
});
/*
